...
export function DropdownExamples() {
  ...
  return (
    <ComponentExamples title="Dropdowns">
      <ComponentInfo
        component="Dropdown"
        description="Select dropdown component with labels, subtext, and various states"
      >
        <p className="mb-2">
          <span className="font-bold">Import:</span>{' '}
          <Code overflow>import Dropdown from &apos;@/shared/ui/Dropdown&apos;</Code>
        </p>
        <p className="mb-2">
          <span className="font-bold">Props:</span> <Code>value</Code>, <Code>onChange</Code>, <Code>items</Code>{' '}
          (DropdownItem[]), <Code>label</Code>, <Code>disabled</Code>, <Code>small</Code>, <Code>menuMaxHeight</Code>,{' '}
          <Code>className</Code>
        </p>
      </ComponentInfo>
      ...
      <ExamplesBlock>
        ...
        <Example title="Dropdown with submenus">
          <Dropdown
            ...
            items={dropdownItemsWithSubmenus}

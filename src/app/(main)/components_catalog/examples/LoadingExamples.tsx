    ...
    <ComponentExamples title="Loading Indicators">
      <ComponentInfo component="LoadingIndicator" description="Loading indicator component with animated dots">
        <p className="mb-2">
          ...
          <Code overflow>import LoadingIndicator from &apos;@/shared/ui/LoadingIndicator&apos;</Code>
        </p>
        <p className="mb-2">
      ...
      <ExamplesBlock>
        <div className="col-span-1 md:col-span-2 lg:col-span-3">
          <ComponentInfo
            ...
            description="Loading spinner component with various sizes and customization options"
          >
            <p className="mb-2">
              <span className="font-bold">Import:</span>{' '}
              <Code overflow>import LoadingSpinner from &apos;@/shared/widgets/LoadingSpinner&apos;</Code>
            </p>
            <p className="mb-2">
              <span className="font-bold">Props:</span> <Code>size</Code> (la-sm, la-lg, la-2x, la-3x),{' '}
              <Code>invert</Code>, <Code>color</Code>, <Code>className</Code>
            </p>
          </ComponentInfo>
        </div>

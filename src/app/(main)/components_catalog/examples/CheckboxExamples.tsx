    ...
    <ComponentExamples title="Checkboxes">
      <ComponentInfo component="Checkbox" description="Checkbox component with different sizes and states">
        <p className="mb-2">
          ...
          <Code overflow>import Checkbox from &apos;@/shared/ui/Checkbox&apos;</Code>
        </p>
        <p className="mb-2">
          <span className="font-bold">Props:</span> <Code>value</Code>, <Code>onChange</Code>, <Code>label</Code>,{' '}
          <Code>small</Code>, <Code>medium</Code>, <Code>disabled</Code>, <Code>partial</Code>
        </p>
      </ComponentInfo>

  ...
  return (
    <div className="max-w-3xl px-4 py-8 mx-auto lg:py-12">
      ...
      <div className="space-y-4">
        {[1, 2].map((item) => (
          <div key={item} className="liquid-glass p-5 flex items-center justify-between group cursor-pointer hover:border-primary/50 transition-colors">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-off-white flex items-center gap-2">
                  Morning Runners <Lock className="w-3 h-3 text-muted-foreground" />
                </h3>
                <p className="text-sm text-muted-foreground">4 members • Last active 2h ago</p>
              </div>
            </div>

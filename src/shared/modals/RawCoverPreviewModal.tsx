...
export default function RawCoverPreviewModal({ isOpen, coverUrl, onClose }: RawCoverPreviewModalProps) {
  ...
  return (
    ...
    >
      <div role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); e.currentTarget.click(); } }} className="relative flex h-full w-full items-center justify-center"  onClick={onClose}>

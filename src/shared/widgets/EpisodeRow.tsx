...
export default function EpisodeRow({
  ...
  return (
    <>
      ...
      >
        {/* Main content */}
        <div role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); e.currentTarget.click(); } }} className="flex h-full flex-col rounded-xl"  onClick={handleRowClick}>
          ...
          <div className="mt-auto flex w-full items-center justify-between gap-2 pt-2">
            <div className="flex w-full items-center gap-2">
              ...
              {episode.audioFile && contextMenuItems.length > 0 && (
                <div role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); e.currentTarget.click(); } }}  onClick={(e) => e.stopPropagation()} className="ms-auto flex-shrink-0">
                  <ContextMenuDropdown

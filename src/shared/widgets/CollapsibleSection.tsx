...
export default function CollapsibleSection({
  ...
  return (
    <div className={mergeClasses('w-full', className)}>
      ...
      <div role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); e.currentTarget.click(); } }} id={headerId} className={headerClasses}  onClick={handleHeaderClick}>
